        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                 <div class="training-program">
                      <h3>
                  <i class="fa-solid fa-file-lines me-2 text-warning" style="color:darkcyan;animation: pulse 1.5s infinite;font-size:2.5rem"></i>
   <span style="color:#FFA521;"> &nbsp;Question Papers</span>
 </h3>
                 </div>
            </div>
        </div>
