...
<div class="row">
                 <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                      <asp:GridView DataKeyNames="Name"  ID="grvFiles" AutoGenerateColumns="false" runat="server" OnSelectedIndexChanged="grvFiles_SelectedIndexChanged" CssClass="grid" Width="100%" style="margin-top:0px;">
        <Columns> 
            <asp:HyperLinkField DataNavigateUrlFields="Name"
                 DataNavigateUrlFormatString="~/Articles/{0}" DataTextField="Name" HeaderText="Articles" HeaderStyle-BackColor="#1E396B"/>

             <asp:CommandField ShowSelectButton="True"   SelectText="Download" ControlStyle-CssClass="btn-accordion" HeaderStyle-BackColor="#1E396B"/>
        </Columns>
    </asp:GridView>
                 </div>
       <%-- Form --%> 
