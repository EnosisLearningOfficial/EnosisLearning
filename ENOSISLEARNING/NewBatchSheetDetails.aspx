<%@ Page Title="" Language="C#" MasterPageFile="~/NewMyAdmin.Master" AutoEventWireup="true" CodeBehind="NewBatchSheetDetails.aspx.cs" Inherits="ENOSISLEARNING.NewBatchSheetDetails" %>
...
<div class="modal fade" id="myChatModal" tabindex="-1" role="dialog" aria-labelledby="chatModalLabel">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    ...
    <div class="batch-info-card mt-2" style="background-color:transparent;">
     ...
     <div class="row">
         <a href="BatchesDetails.aspx" class="btn btn-danger" style="width:15%;margin:auto">
...
<script>
    $(document).ready(function () {
        $('#tblBatchSheet').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: 'NewBatchSheetDetails.aspx/GetBatchSheetDetails',
                type: 'POST',
...
<script>
    ...
    function saveBatchSheet(fileName) {
        ...
        $.ajax({
            type: "POST",
            url: "NewBatchSheetDetails.aspx/AddBatchSheet",
...
<script>
    ...
    $(document).on("click", ".edit-btn", function () {
        ...
        $.ajax({
            url: "NewBatchSheetDetails.aspx/GetBatchSheetById",
            type: "POST",
    ...
    function updateBatch() {
        ...
        function sendUpdate() {
            $.ajax({
                url: "NewBatchSheetDetails.aspx/UpdateBatchSheet",
                method: "POST",
                contentType: "application/json; charset=utf-8",
...
<script>
    ...
    function deleteBatchSheet(batchSheetId) {
        $.ajax({
            type: "POST",
            url: "NewBatchSheetDetails.aspx/DeleteBatchSheet",
