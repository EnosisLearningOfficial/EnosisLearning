  ...
  <div class="row">
     <div class="col-lg-12 col-sm-12">
        <div class="training-program"><h3>              
            <i class="fa-solid fa-laptop-code me-2" style="color:#1E3969;animation: pulse 1.5s infinite;font-size:2.5rem"></i>
<span style="color:#FFA521;">Enosis Learning Training Assignments</span></h3></div>
     </div>
  </div>
<div class="row">
...
<div class="panel-body">
<div class="col-lg-12">
<asp:GridView DataKeyNames="Name"  ID="grvPowerBI" HeaderStyle-BackColor="#e4eef2" AutoGenerateColumns="false" runat="server" OnSelectedIndexChanged="grvPowerBI_SelectedIndexChanged">
<Columns> 
<asp:HyperLinkField DataNavigateUrlFields="Name"
DataNavigateUrlFormatString="~/Assignments/PowerBI/{0}"  ItemStyle-Font-Size="Small"  ControlStyle-ForeColor="#F39224" ControlStyle-Font-Bold="true" DataTextField="Name" HeaderText="DownLoads"  />
