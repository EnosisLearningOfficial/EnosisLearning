...
#accordion .panel-default > .panel-heading {
    background-color: #173151 !important;  /* apna desired color */
...
#accordion .panel-title a .myicon {
  ...
  justify-content: flex-start; /* center the text with icons */
  gap: 8px; /* space between icon and text */
  color: #173151; /* or keep existing color */
}

.training-program h3 i {
  color: #ffd700; /* golden icons for elegance */
           ...
           <div class="row">
            <div class="col-lg-12 col-sm-12">
               <div class="training-program">
                  <h3>
                               <i class="fa-solid fa-lightbulb me-2" style="color:gold;animation: pulse 1.5s infinite;font-size:2.5rem"></i>
<span style="color:#FFA521;">Enosis Learning Study Modules</span>
                  </h3>
                </div>
            </div>
        </div>
...
<div class="panel-body">
<div class="col-lg-12">
<asp:GridView DataKeyNames="Name"  ID="grvCPP" AutoGenerateColumns="false" runat="server"  Width="340px" Height="60px" >
<Columns> 
<asp:HyperLinkField DataNavigateUrlFields="Name"
...
<tr class="tbl-head">
<td colspan="2" style="background:linear-gradient(135deg, #173151, #1f3a6e);">Tutorials</td>
<%--<td style="background:linear-gradient(135deg, #173151, #1f3a6e);"></td>--%>
</tr>
<tr>
